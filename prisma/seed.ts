...
async function main() {
  ...
  const aleoProjects = [
    {
      name: 'Obscura',
      description: 'The development platform for privacy enhanced applications.',
      website: 'https://obscura.build/',
      githubUrl: 'https://github.com/obscura-network/obscura',
      twitterUrl: 'https://x.com/Obscura_Build',
      logoUrl: 'https://pbs.twimg.com/profile_images/1768753534739038208/dzwAqsVM_400x400.jpg',
      blockchain: 'aleo'
    },
    {
      name: 'AleoNames',
      description: 'ANS is a user-friendly protocol on the Aleo network, allowing easy mapping of human-readable names to network resources and identifiers.',
      website: 'https://aleonames.id/',
      githubUrl: 'https://github.com/S-T-Soft/aleo-name-service-contract',
      twitterUrl: 'https://x.com/aleonames',
      logoUrl: 'https://docs.aleonames.id/~gitbook/image?url=https%3A%2F%2F3184937858-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FpyXzr7xRBxgMJLweHrOR%252Ficon%252FjFYnZSZIfTePl9CB0vv1%252FANS-03.png%3Falt%3Dmedia%26token%3Dc2752c82-b7f6-483f-8115-02c6d307f68e&width=32&dpr=2&quality=100&sign=48da922e&sv=2',
      blockchain: 'aleo'
    },
    {
      name: 'AlphaSwap',
      description: 'AlphaSwap (previously AleoSwap) offers private, secure, and smooth trading experience on the Aleo',
      website: 'https://alphaswap.pro/',
      githubUrl: 'https://github.com/aleoswap-labs/aleoswap',
      twitterUrl: 'https://x.com/AlphaSwap_dex',
      logoUrl: 'https://alphaswap.pro/_nuxt/logo-text.3tQ7OnGU.svg',
      blockchain: 'aleo'
    },
    {
      name: 'Arcane Finance',
      description: 'A privacy-centric decentralized exchange on @AleoHQ combining RFQ and AMM.',
      website: 'https://www.arcane.finance/',
      githubUrl: 'https://github.com/arcane-finance-defi/arcane-core',
      twitterUrl: 'https://x.com/arcane_finance',
      logoUrl: 'https://cdn.prod.website-files.com/650e930af281c025773dfb28/65114237b8b06a1290ec88cb_dwqdqwd.svg',
      blockchain: 'aleo'
    },
    {
      name: 'Fox Wallet',
      ...
      githubUrl: 'https://github.com/foxwallet/foxwallet-extension',
      twitterUrl: 'https://x.com/FoxWallet',
      logoUrl: 'https://foxwallet.com/_nuxt/img/logo.9a0e3c7.svg',
      blockchain: 'aleo'
    },
    {
      name: 'Verulink',
      description: 'Verulink is a pioneering solution designed to facilitate secure and efficient cross-chain transactions between the Ethereum and Aleo blockchains.',
      website: 'https://www.verulink.com/',
      githubUrl: 'https://github.com/venture23-aleo/verulink',
      twitterUrl: 'https://x.com/verulink',
      logoUrl: 'https://www.verulink.com/_next/static/media/verulink-logo.70d08e91.svg',
      blockchain: 'aleo'
    }
  ];

  // Add all projects with random ratings
  for (const project of [...stellarProjects, ...aptosProjects, ...bahamutProjects, ...polkadotProjects, ...aleoProjects]) {
